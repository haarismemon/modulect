!function (e, t) {
    ...
    var e = {
        ...
        r = n(["success", "warning", "info", "question", "error"]), i = function (e, t) {
            ...
            var r = c(), i = A(r, o.input), a = A(r, o.file), l = r.querySelector("." + o.range + " input"),
        ...
        u = function () {
            ...
            switch (j(n[0])) {
                case"string":
                    ...
                    break;
                case"object":
                    K(l, n[0]), l.extraParams = n[0].extraParams, "email" === l.input && null === l.inputValidator && (l.inputValidator = function (e) {
            ...
            return new Promise(function (t, n) {
                ...
                var r = function (e) {
                    ...
                    switch (e) {
                        ...
                        case"radio":
                            return d.querySelector("." + o.radio + " input:checked") || d.querySelector("." + o.radio + " input:first-child");
                        case"range":
                ...
                for (var x = function (n) {
                        ...
                        var o = t || window.event, r = o.target || o.srcElement, a = b(), s = w(), u = a === r || a.contains(r),
                            c = s === r || s.contains(r);
                        switch (o.type) {
                            case"mouseover":
                            case"mouseup":
                                l.buttonsStyling && (u ? a.style.backgroundColor = i(l.confirmButtonColor, -.1) : c && (s.style.backgroundColor = i(l.cancelButtonColor, -.1)));
                                break;
                            case"mouseout":
                                l.buttonsStyling && (u ? a.style.backgroundColor = l.confirmButtonColor : c && (s.style.backgroundColor = l.cancelButtonColor));
                                break;
                            case"mousedown":
                                l.buttonsStyling && (u ? a.style.backgroundColor = i(l.confirmButtonColor, -.2) : c && (s.style.backgroundColor = i(l.cancelButtonColor, -.2)));
                                break;
                            case"click":
                                u && e.isVisible() ? (e.disableButtons(), l.input ? !function () {
                                    var t = p();
                                    l.inputValidator ? (e.disableInput(), l.inputValidator(t, l.extraParams).then(function () {
                                        e.enableButtons(), e.enableInput(), x(t)
                                    }, function (t) {
                                        e.enableButtons(), e.enableInput(), t && e.showValidationError(t)
                                    })) : x(t)
                                }() : x(!0)) : c && e.isVisible() && (e.disableButtons(), e.closeModal(l.onClose), n("cancel"))
                        }
                ...
                var K = function (e, t) {
                    ...
                    if ([9, 13, 32, 27].indexOf(r) !== -1) {
                        for (var i = o.target || o.srcElement, a = k(l.focusCancel), s = -1,
                                 u = 0; u < a.length; u++)if (i === a[u]) {
                            s = u;
                            break
                        }
                        9 === r ? (o.shiftKey ? K(s, -1) : K(s, 1), o.stopPropagation(), o.preventDefault()) : 13 === r || 32 === r ? s === -1 && l.allowEnterKey && (l.focusCancel ? V(I, o) : V(H, o)) : 27 === r && l.allowEscapeKey === !0 && (e.closeModal(l.onClose), n("esc"))
                    }
                };
                a.previousWindowKeyDown = window.onkeydown, window.onkeydown = D, l.buttonsStyling && (H.style.borderLeftColor = l.confirmButtonColor, H.style.borderRightColor = l.confirmButtonColor), e.showLoading = e.enableLoading = function () {
                    P(h()), P(H, "inline-block"), E(H, o.loading), E(d, o.loading), H.disabled = !0, I.disabled = !0
                }, e.hideLoading = e.disableLoading = function () {
                    l.showConfirmButton || (T(H), l.showCancelButton || T(h())), B(H, o.loading), B(d, o.loading), H.disabled = !1, I.disabled = !1
                }, e.getTitle = function () {
                    return f()
                    ...
                    var e = r();
                    if (!e)return !1;
                    if ("radio" === e.type)for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"),
                                                    o = 0; o < n.length; o++)n[o].disabled = !1; else e.disabled = !1
                }, e.disableInput = function () {
                    var e = r();
                    if (!e)return !1;
                    if (e && "radio" === e.type)for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"),
                                                         o = 0; o < n.length; o++)n[o].disabled = !0; else e.disabled = !0
                ...
                for (var W = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], Q = void 0,
                         Y = 0; Y < W.length; Y++) {
                    var Z = o[W[Y]], J = A(d, Z);
                    if (Q = r(W[Y])) {
                        for (var X in Q.attributes)if (Q.attributes.hasOwnProperty(X)) {
                ...
                !function () {
                    switch (l.input) {
                        ...
                        case"number":
                        case"tel":
                            Q = A(d, o.input), Q.value = l.inputValue, Q.placeholder = l.inputPlaceholder, Q.type = l.input, P(Q);
                            break;
                        case"file":
                            Q = A(d, o.file), Q.placeholder = l.inputPlaceholder, Q.type = l.input, P(Q);
                            break;
                        case"range":
                            var e = A(d, o.range), t = e.querySelector("input"), n = e.querySelector("output");
                        ...
                        case"select":
                            ...
                            if (i.innerHTML = "", l.inputPlaceholder) {
                                ...
                                a.innerHTML = l.inputPlaceholder, a.value = "", a.disabled = !0, a.selected = !0, i.appendChild(a)
                            }
                            F = function (e) {
                                for (var t in e) {
                                    var n = document.createElement("option");
                                    n.value = t, n.innerHTML = e[t], l.inputValue === t && (n.selected = !0), i.appendChild(n)
                                }
                                P(i), i.focus()
                            };
                            break;
                        case"radio":
                            ...
                            s.innerHTML = "", F = function (e) {
                                for (var t in e) {
                                    ...
                                    n.type = "radio", n.name = o.radio, n.value = t, l.inputValue === t && (n.checked = !0), i.innerHTML = e[t], r.appendChild(n), r.appendChild(i), r.for = n.id, s.appendChild(r)
                                }
                                P(s);
                        ...
                        case"checkbox":
                            ...
                            c.type = "checkbox", c.value = 1, c.id = o.checkbox, c.checked = Boolean(l.inputValue);
                            var p = u.getElementsByTagName("span");
                            p.length && u.removeChild(p[0]), p = document.createElement("span"), p.innerHTML = l.inputPlaceholder, u.appendChild(p), P(u);
                            break;
                        case"textarea":
                        ...
                        case null:
                            break;
                        default:
                            console.error('SweetAlert2: Unexpected type of input! Expected "text", "email", "password", "select", "checkbox", "textarea" or "file", got "' + l.input + '"')
                    }
